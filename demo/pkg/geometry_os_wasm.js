/* @ts-self-types="./geometry_os_wasm.d.ts" */
...
export class GeometryOS {
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        GeometryOSFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_geometryos_free(ptr, 0);
    }
    /**
     ...
     */
    disassemble_at(addr) {
        const ret = wasm.geometryos_disassemble_at(this.__wbg_ptr, addr);
     ...
     */
    get_beep() {
        const ret = wasm.geometryos_get_beep(this.__wbg_ptr);
        return ret;
    }
    /**
     * Get the frame count.
     ...
     */
    get_frame_count() {
        const ret = wasm.geometryos_get_frame_count(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * Get the current PC.
     ...
     */
    get_pc() {
        const ret = wasm.geometryos_get_pc(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     */
    get_reg(reg) {
        const ret = wasm.geometryos_get_reg(this.__wbg_ptr, reg);
        return ret >>> 0;
    }
    /**
     ...
     */
    is_halted() {
        const ret = wasm.geometryos_is_halted(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     ...
     */
    key_clear() {
        wasm.geometryos_key_clear(this.__wbg_ptr);
    }
    /**
     ...
     */
    key_press(key_code) {
        wasm.geometryos_key_press(this.__wbg_ptr, key_code);
    }
    /**
    ...
    load(source) {
        ...
        const ret = wasm.geometryos_load(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
    ...
    constructor(canvas_id) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.geometryos_new(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
        GeometryOSFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     ...
     */
    peek(addr) {
        const ret = wasm.geometryos_peek(this.__wbg_ptr, addr);
        return ret >>> 0;
    }
    /**
     * Write a word to RAM.
     ...
     */
    poke(addr, value) {
        wasm.geometryos_poke(this.__wbg_ptr, addr, value);
    }
    /**
     * Reset the VM to a clean state.
     */
    reset() {
        wasm.geometryos_reset(this.__wbg_ptr);
    }
    /**
     ...
     */
    step() {
        const ret = wasm.geometryos_step(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     ...
     */
    tick() {
        const ret = wasm.geometryos_tick(this.__wbg_ptr);
        return ret !== 0;
    }
}
if (Symbol.dispose) GeometryOS.prototype[Symbol.dispose] = GeometryOS.prototype.free;
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./geometry_os_wasm_bg.js": import0,
    };
}

const GeometryOSFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_geometryos_free(ptr >>> 0, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('geometry_os_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
