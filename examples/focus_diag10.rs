...
fn main() {
    ...
    println!("BEFORE Enter: RAM[4095]={}, RAM[4094]={}, RAM[4093]={}, RAM[4096]={}", 
    ...
    while !vm.yielded && !vm.halted && step < 5000 {
        ...
        if vm.ram[4095] != prev_ram_4095 {
            println!("Step {}: RAM[4095] changed from {} to {}!", step-1, prev_ram_4095, vm.ram[4095]);
        }
    }
    
    println!("\nAFTER: halted={}, PC={}, step={}", vm.halted, vm.pc, step);
    println!("RAM[4095]={}, RAM[4094]={}, RAM[4093]={}, RAM[4096]={}", 
             vm.ram[4095], vm.ram[4094], vm.ram[4093], vm.ram[4096]);
}