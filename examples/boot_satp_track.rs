fn main() {
    ...
    while count < max_instr {
        ...
        if count % 100 == 0 {
            ...
            if satp != last_satp && last_satp != 0 {
                ...
                eprintln!("[SATP] count={} PC=0x{:08X}: 0x{:08X} -> 0x{:08X}", count, vm.cpu.pc, last_satp, satp);
            }
            last_satp = satp;
        }
    ...
    eprintln!("[DONE] count={} PC=0x{:08X} satp=0x{:08X} changes={}", 
        count, vm.cpu.pc, vm.cpu.csr.read(csr::SATP), satp_changes.len());
}
