...
fn main() {
    ...
    for frame in 0..20 {
        ...
        vm.yielded = false;
        if vm.halted {
            println!("VM halted at frame {} after {} cycles, PC={}", frame, cycles, vm.pc);
            break;
        }
    }
    
    println!("After init: halted={}, PC={}, RAM[0x7820]={}, RAM[0x7821]{}", 
    ...
    for (ki, &key) in keys.iter().enumerate() {
        ...
        if vm.halted {
            println!("VM halted at key {} (0x{:02X}) after {} cycles, PC={}", ki, key, cycles, vm.pc);
            break;
        }
    }
    
    println!("After /focus 0x40: halted={}, PC={}, RAM[0x7821]={}", 
