        ...
        if vm.cpu.privilege == geometry_os::riscv::cpu::Privilege::Supervisor {
            if vm.cpu.csr.scause != 0 {
                ...
                if cause_code == 13 || cause_code == 12 || cause_code == 15 {
                    println!("[{}] S-mode page fault: scause={} sepc={:#010x} stval={:#010x}",
                    ...
                    let vpn = [
                        (fault_vaddr >> 22) & 0x3FF,
                        (fault_vaddr >> 12) & 0x3FF,
                    ];
                    ...
                    println!("  L1[{:#x}] at {:#010x} = {:#010x} V={} R={} X={} PPN={:#x}",
                    ...
                    if l1_v != 0 && l1_r == 0 && l1_x == 1 {
                        ...
                        println!("  L2[{:#x}] at {:#010x} = {:#010x} V={} R={} W={} X={} PPN={:#x}",
