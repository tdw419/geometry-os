...
fn main() {
            ...
            if cause_code == 11 || cause_code == 9 {
                ...
                if stvec != 0 {
                    ...
                    if cause_code == 2 && first_trap {
                        ...
                        eprintln!("[diag] sepc=0x{:08X} mpp={} stvec=0x{:08X}", vm.cpu.csr.sepc, mpp, stvec);
                        ...
                        eprintln!("[diag] SP=0x{:08X} RA=0x{:08X} GP=0x{:08X} TP=0x{:08X}",
                            vm.cpu.x[2], vm.cpu.x[1], vm.cpu.x[3], vm.cpu.x[4]);
                        eprintln!("[diag] T0=0x{:08X} T1=0x{:08X} T2=0x{:08X} S0=0x{:08X} S1=0x{:08X}",
    ...
    eprintln!("[diag] SBI calls={}, forwards={}, illegal={}", sbi_call_count, forward_count, illegal_count);
    if first_trap {
        eprintln!("[diag] No illegal trap in {} instructions. PC=0x{:08X} priv={:?}", count, vm.cpu.pc, vm.cpu.privilege);
    }
}
