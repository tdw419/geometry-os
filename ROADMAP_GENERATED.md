...
Pixel-art virtual machine with built-in assembler, debugger, and live GUI. 115 opcodes, 32 registers, 64K RAM, 256x256 framebuffer. Write assembly in the built-in text editor, press F5, watch it run.
